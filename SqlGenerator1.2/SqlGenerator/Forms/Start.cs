    ...
    public partial class Start : Form
    {
        ...
        private void Generate(CommandType commandType)
        {
            try
            {
                ...
                result = ResultCreator.GetResult(commandType, fileRows, MappedColumns, cboTableNameTarget.Text);
        ...
        {
            connectionStrings = (List<ConnectionItem>)cboConnectionTarget.DataSource;
        ...
        private void btnEnterToTheDatabase(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(result)) // Check if result is not empty
            {
                ...
                DialogResult dialogResult = MessageBox.Show($"Are you sure you want to add it to the database?\n\n{result}", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void txtResult_Load(object sender, EventArgs e)
        {
